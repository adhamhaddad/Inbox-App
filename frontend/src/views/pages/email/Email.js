...
import MailLog from 'src/views/pages/email/MailLog'
import SidebarLeft from 'src/views/pages/email/SidebarLeft'
import ComposePopup from 'src/views/pages/email/ComposePopup'
...
import { getUserByEmail } from 'src/store/apps/user'
