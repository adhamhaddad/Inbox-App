            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <div>
                <IconButton
                  ...
                  sx={{ mr: 1, ...(mail.is_starred ? { color: 'warning.main' } : {}) }}
                >
                            ...
                            >
                              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <ImgStyled
                                  ...
                                  src={reply.from.avatar ? `${API_URL}/${reply.from.avatar}` : '/images/avatars/1.png'}
                              ...
                              <Box sx={{ p: 5 }}>
                                ...
                                <List>
                                  {reply.attachments.map(item => {
                                    return (
                                      <ListItem disableGutters key={item.file_name}>
                                        <ListItemIcon>
                                          <img src={item.thumbnail} alt={item.file_name} width='24' height='24' />
                                        </ListItemIcon>
